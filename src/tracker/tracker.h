...
const std::wstring SECTION_WINDOW(L"Window");
	...
	const std::wstring KEY_MAX_HISTORY(L"MaxHistory");				constexpr int VAL_MAX_HISTORY      = 16;
	...
	const std::wstring KEY_LINE_HEIGHT(L"LineHeight");				constexpr int VAL_LINE_HEIGHT       = 14;
	const std::wstring KEY_FULL_SCREEN_CHECK(L"FullScreenCheck");	constexpr int VAL_FULL_SCREEN_CHECK = 0;

	const std::wstring KEY_WIDTH(L"Width");							constexpr int VAL_WIDTH  = 120;
	const std::wstring KEY_HEIGHT(L"Height");						constexpr int VAL_HEIGHT = 480;
	...
	const std::wstring KEY_FONT_SIZE(L"FontSize");					constexpr int VAL_FONT_SIZE = 13;
